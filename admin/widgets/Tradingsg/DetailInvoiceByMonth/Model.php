<?
class CPL_Admin_Widgets_Tradingsg_DetailInvoiceByMonth_Model extends CP_Admin_Widgets_Tradingsg_DetailInvoiceByMonth_Model
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        if ($cpCfg['cp.hasMultiUniqueSites']){
            ...
            $searchVar->sqlSearchVar[] = "site_id = '{$cpSiteIdSession}'";
        }
