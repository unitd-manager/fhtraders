<?
class CPL_Admin_Widgets_Tradingsg_SalesByMonthChart_Model extends CP_Admin_Widgets_Tradingsg_SalesByMonthChart_Model
{
    /**
     *
     */
    ...
    function setSearchVar() {
        ...
        if ($cpCfg['cp.hasMultiUniqueSites']){
            ...
            $searchVar->sqlSearchVar[] = "o.site_id = '{$cpSiteIdSession}'";
        }
