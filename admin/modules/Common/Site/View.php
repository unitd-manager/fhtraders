<?
class CPL_Admin_Modules_Common_Site_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getEdit($row) {
        ...
        {$formObj->getTBRow('City / Town', 'address_town', $row['address_town'])}
        ...
        {$formObj->getTBRow('Website', 'site_url', $row['site_url'])}
        ";
