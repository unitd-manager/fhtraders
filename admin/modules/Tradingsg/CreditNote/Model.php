<?
class CPL_Admin_Modules_Tradingsg_CreditNote_Model extends CP_Admin_Modules_Tradingsg_CreditNote_Model
{
    ...
    function setSearchVar() {
        ...
        if ($credit_note_id != "") {
            $searchVar->sqlSearchVar[] = "i.credit_note_id = '{$credit_note_id}'";
        } else if ($tv['record_id'] != '') {
            $searchVar->sqlSearchVar[] = "i.credit_note_id = '{$tv['record_id']}'";
        } else {
