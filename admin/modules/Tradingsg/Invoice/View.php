...
class CPL_Admin_Modules_Tradingsg_Invoice_View extends CP_Admin_Modules_Tradingsg_Invoice_View
{
    ...
    function getList($dataArray) {
        ...
        foreach ($dataArray as $row){
            ...
            $urlInvoicePrint = "index.php?_topRm=finance&module=tradingsg_order&_spAction=printInvoiceRecord&invoice_code={$row['invoice_code']}&invoice_id={$row['invoice_id']}&invoice_type=normal&footer_logo=yes&showHTML=0";
        ...
        $rows .="
            ...
            {$listObj->getListPublishedImage($row['published'], $row['invoice_id'])}
