<?
class CPL_Admin_Modules_Tradingsg_Expense_View extends CP_Common_Lib_ModuleViewAbstract
{
   function getList($dataArray){
    ...
    function getEdit($row){
        ...
        if ($cpCfg['cp.hasMultiUniqueSites']) {
            ...
            $siteNameHidden = "
            <input type='hidden' name='site_name' value='{$rowSite['title']}' id='fld_site_name_hidden' />
            ";
        }
    ...
    function getEdit1($row){
        ...
        $formAddGroup = "index.php?_topRm={$tv['topRm']}&module=tradingsg_expense&_spAction=addNewValuelistForm&valuelist_name=Group&expense_id={$row['expense_id']}&showHTML=0";
