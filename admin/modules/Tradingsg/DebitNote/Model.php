<?
class CPL_Admin_Modules_Tradingsg_DebitNote_Model extends CP_Admin_Modules_Tradingsg_DebitNote_Model
{
    ...
    function setSearchVar() {
        ...
        if ($debit_note_id != "") {
            $searchVar->sqlSearchVar[] = "i.debit_note_id = '{$debit_note_id}'";
        } else if ($tv['record_id'] != '') {
            $searchVar->sqlSearchVar[] = "i.debit_note_id = '{$tv['record_id']}'";
        } else {
